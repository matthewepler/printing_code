...
void renderDrop() {
  ...
  for(int y=0; y<canvas_height - dropHeight*8; y+=vertFreq){
    ...
    canvas.bezierVertex(0, y + dropHeight * 7,         // control point 1
                        dropWidth, y + dropHeight * 7, // control point 2
                        dropWidth, ypos);              // anchor point   
    canvas.vertex(dropWidth/2, margin);
    canvas.endShape(CLOSE);
  }
  //canvas.save("wetSharp1_1.tif"); 
