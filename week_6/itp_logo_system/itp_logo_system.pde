...
void initControls() {
  ...
  controlP5.addSlider("drawCut",0,5).linebreak();
  controlP5.addSlider("boxWidth",0,10).linebreak();
  controlP5.addSlider("offset",-2,1).linebreak();
  controlP5.addSlider("dim",10,80).linebreak();
  controlP5.addSlider("dim_cutter",0.1,6).linebreak();
